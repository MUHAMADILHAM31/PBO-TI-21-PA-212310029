...
public class RoketGame extends JFrame implements KeyListener {
...
//        ImageIcon icon = new ImageIcon("/rocket.png");
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (x < 0) {
            ...
            // Change object to another image
        	Image icon = new ImageIcon (this.getClass().getResource("/Rocket1.png")).getImage();
        	rocket.setIcon(new ImageIcon (icon));
            x = 405;
        } else if (y < 0 || y > 290) {
            // Change object to another image
